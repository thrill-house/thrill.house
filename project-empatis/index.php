...
<html>
	<head>
		...
		<title>Project EMPATIS — brought to you by Thrillhouse OÜ</title>
	...
	<body class="container mx-auto leading-normal text-indigo-dark bg-orange-lightest">
		<header id="header" class="md:flex mt-2">
			...
			<div class="p-4 pt-0 md:pt-4  md:w-3/4">
				<h1 class="text-5xl font-mono font-hairline text-orange border-b border-orange-lighter">Project EMP<span class="font-bold">A</span>T<span class="font-bold">I</span>S</h1>
		...
		<main id="main" class="border-t-2 border-indigo-dark py-4">
			<?php if (array_key_exists('medienboard', $_GET)): ?>
				<div id="mbbb" class="lg:flex flex-wrap my-8 mx-4 bg-white text-black rounded-lg shadow-lg">
					...
					<div class="p-8 pt-4 lg:p-8 lg:w-2/3">
						...
						<p class="mt-2">Wir von <strong class="italic">Thrillhouse</strong> freuen uns darauf Ihnen unser neues Browserspiel <em>Project EMP<strong>A</strong>T<strong>I</strong>S</em> für Ihre Überlegungen zur Finanzierung einer <strong class="italic">New Media Förderung</strong> vorzustellen, um die Entwicklung und Einführung unseres spannenden Spiels zu unterstützen. Für Fragen stehen wir Ihnen jederzeit gerne zur Verfügung. Sie erreichen <strong class="italic">Mike Pierce</strong> per E-Mail unter <strong class="italic"><a href="mailto:welcome@thrill.house" class="text-red-light">welcome@thrill.house</a></strong> oder telefonisch unter <strong class="italic"><a href="tel:+49 176 7029 5102" class="text-red-light">+49 176 7029 5102</a></strong>.</p>
					</div>
				</div>
			<?php endif; ?>
			<div id="concept" class="lg:flex flex-row-reverse">
				...
				<div class="p-4 lg:w-1/2 xl:w-1/3">
					...
					<p class="text-xl mt-2"><strong class="italic">Project EMPATIS</strong>:<br><strong>E</strong>motionally <strong>M</strong>ature <strong>P</strong>aradigm <strong>A</strong>nalyst <strong>T</strong>oward <strong>I</strong>nterpersonal<strong> S</strong>ynergies.</p>
          ...
          <p class="mt-2 text-center"><a href="https://medium.com/dash-game" class="bg-indigo-dark hover:bg-indigo text-lg font-mono text-white no-underline p-3 rounded inline-block">Check out our blog on Medium</a></p>
			...
			<div id="features" class="mt-4 md:flex border-t border-indigo-lighter pt-4">
				...
				<div class="p-4 md:w-2/3">
					...
					<p class="mt-2"><strong class="italic">Project EMPATIS</strong> combines elements of the proven genre of <strong class="italic">idle games</strong> with the emerging technological revolution that is <strong class="italic">cryptocurrency</strong> and <strong class="italic">blockchain</strong>.</p>
			...
			<div id="roadmap" class="mt-4 md:flex flex-wrap border-t border-indigo-lighter pt-4">
				...
				<div class="p-4 pb-0 md:pb-4 md:w-1/2">
					<dl class="mt-2">
						...
						<dt class="mt-2 font-bold">Story &amp; Script <em class="text-xs bg-blue py-1 px-2 rounded-full text-white font-mono">In progress</em></dt>
						<dd class="ml-4">Story told in 2 acts. Character arcs defined, dialogue writing in progress.</dd>
						<dt class="mt-2 font-bold">Interface design <em class="text-xs bg-blue py-1 px-2 rounded-full text-white font-mono">In progress</em></dt>
		...
		<footer id="footer" class="border-t-2 border-indigo-dark md:flex">
			<div class="w-3/5 md:w-4/5 lg:w-3/4 p-4">
				<h6 class="text-xs italic font-light">Project EMPATIS is brought to you by <a href="https://thrill.house/" class="text-indigo">Thrillhouse OÜ</a></h6>
			</div>
